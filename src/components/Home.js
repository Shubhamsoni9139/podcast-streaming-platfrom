...
const Home = () => {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        const data = [
          { urls: { small: 'https://www.smartpassiveincome.com/wp-content/uploads/2021/12/Learn-How-to-Podcast.png' }, alt_description: 'Podcast Image 1' },
          { urls: { small: 'https://www.smartpassiveincome.com/wp-content/uploads/2019/11/askpat-2.0-logo-e1574394792545.png' }, alt_description: 'Podcast Image 2' },
          { urls: { small: 'https://www.searchenginejournal.com/wp-content/uploads/2020/02/7-tips-to-make-a-successful-podcast-5e3d9fa1ad735-1520x800.webp' }, alt_description: 'Podcast Image 3' },
        ];
...
const episodeDetails = [
...

    {
      ...
      description: 'Welcome to Perspectives Unboxed, where we unpack diverse viewpoints through thought-provoking conversations and unexpected discussions. Engage with us as we explore unconventional ideas, challenge societal norms, and dive into the complexity of human experiences. Join our open-minded community as we unravel unique perspectives, inviting you to expand your horizons and see the world through different lenses.',
    },
    {
      title: 'Episode 3:Perspectives Unboxed: Unconventional Dialogues',
      description: 'Welcome to Perspectives Unboxed, where we unpack diverse viewpoints through thought-provoking conversations and unexpected discussions. Engage with us as we explore unconventional ideas, challenge societal norms, and dive into the complexity of human experiences. Join our open-minded community as we unravel unique perspectives, inviting you to expand your horizons and see the world through different lenses.',
